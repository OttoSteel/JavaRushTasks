...
//            return assets != null ? assets.equals(human.assets) : human.assets == null;
        ...
        public String toString() {
            return this.name + " " + this.assets.get(0);
        }
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            if (assetsSize != 0) {
                for (int i = 0; i < assetsSize; i++) {
                    ...
                    double assetPrice;
                    if (!(assetPriceString.equals("no price"))) {
                        assetPrice = Double.parseDouble(assetPriceString);
                        assets.get(i).setPrice(assetPrice);
                    }
                }
            }
        }
